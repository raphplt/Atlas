	...
	return (
		<section className="relative py-20 sm:py-32 overflow-hidden" id="portfolio">
			...
			<div className="container relative">
				...
				<p className="lead mb-8 sm:mb-12 text-center motion-slide-up motion-delay-100 motion-duration-1000 motion-intersect-start motion-intersect-end motion-intersect-threshold-75 line-clamp-2">
					{t("subtitle")}
				</p>

				<div className="flex justify-center mb-8 sm:mb-12 motion-scale-in motion-delay-200 motion-intersect-start motion-intersect-end motion-intersect-threshold-75">
				...
				{activeTab === "gallery" && (
					<div className="space-y-8 sm:space-y-12 motion-fade-in motion-delay-300 motion-intersect-start motion-intersect-end motion-intersect-threshold-50">
						<div className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
							{projects.map((project, index) => (
								...
								>
									<div className="project-card relative overflow-hidden rounded-2xl sm:rounded-3xl bg-[var(--color-card)] border border-[var(--color-border)] shadow-[var(--shadow-sm)] motion-slide-up motion-delay-500 flex flex-col h-full">
										{/* Badge de résultat */}
										...
										<div className="p-3 sm:p-5 relative flex flex-col h-full">
											...
											<div className="flex-1 flex flex-col">
												...
												{/* Métriques rapides */}
												<div className="flex items-center gap-2 sm:gap-4 text-[10px] sm:text-xs text-[var(--color-muted)] opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 mt-auto">
				...
				{activeTab === "case-studies" && (
					<div className="space-y-16 sm:space-y-24 motion-fade-in motion-delay-300 motion-intersect-start motion-intersect-end motion-intersect-threshold-50">
						{featuredProjects.map((project, index) => (
							<div
								key={project.id}
								className={`grid lg:grid-cols-2 gap-8 sm:gap-12 items-center motion-slide-up motion-delay-400 motion-intersect-start motion-intersect-end motion-intersect-threshold-50 ${
							...
							>
								...
								>
									<div className="absolute -top-4 sm:-top-6 left-1/2 -translate-x-1/2 text-[9px] sm:text-[10px] md:text-xs px-2 sm:px-3 py-1 rounded-full bg-[var(--color-bg)]/80 border border-[var(--color-border)] motion-fade-in motion-delay-600">
										{project.title}
									</div>
									<BeforeAfterSlider
										beforeSrc={project.beforeSrc}
								...
								<div
									className={`space-y-4 sm:space-y-6 motion-fade-in motion-delay-700 ${index % 2 === 1 ? "lg:col-start-1" : ""}`}
								>
									...
									<div className="space-y-3 sm:space-y-4 motion-scale-in motion-delay-900">
										...
										<ul className="space-y-2 sm:space-y-3">
											{project.improvements.map((improvement, idx) => (
												<li
													key={idx}
													className="flex items-start gap-2 sm:gap-3 motion-fade-in motion-delay-1000"
												>
									...
									<div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[var(--color-accent)]/5 to-[var(--color-accent-alt)]/5 border border-[var(--color-accent)]/20 motion-scale-in motion-delay-1100">
										...
										<div className="grid grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
											<div className="text-center motion-fade-in motion-delay-1300">
												<div className="text-xl sm:text-2xl font-bold text-[var(--color-accent)] motion-wiggle motion-delay-1400">
													+150%
												</div>
											...
											<div className="text-center motion-fade-in motion-delay-1400">
												<div className="text-xl sm:text-2xl font-bold text-[var(--color-accent)] motion-wiggle motion-delay-1500">
													+80%
												</div>
												<div className="text-[var(--color-muted)]">
													{t("metrics.contacts")}
